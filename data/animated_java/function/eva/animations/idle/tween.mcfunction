...
tag @s add aj.eva.animation.idle.playing
...
execute at @s run function animated_java:eva/animations/idle/zzz/apply_frame {frame: 0}
$execute at @s run function animated_java:eva/animations/idle/zzz/apply_frame {frame: $(to_frame)}
