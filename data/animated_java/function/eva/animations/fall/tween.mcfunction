...
execute at @s run function animated_java:eva/animations/fall/zzz/apply_frame {frame: 0}
$execute at @s run function animated_java:eva/animations/fall/zzz/apply_frame {frame: $(to_frame)}
