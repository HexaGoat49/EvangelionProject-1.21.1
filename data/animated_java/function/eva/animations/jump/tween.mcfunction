...
tag @s add aj.eva.animation.jump.playing
...
execute at @s run function animated_java:eva/animations/jump/zzz/apply_frame {frame: 0}
$execute at @s run function animated_java:eva/animations/jump/zzz/apply_frame {frame: $(to_frame)}
