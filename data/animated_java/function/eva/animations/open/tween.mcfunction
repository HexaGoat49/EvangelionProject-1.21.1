...
tag @s add aj.eva.animation.open.playing
...
execute at @s run function animated_java:eva/animations/open/zzz/apply_frame {frame: 0}
$execute at @s run function animated_java:eva/animations/open/zzz/apply_frame {frame: $(to_frame)}
