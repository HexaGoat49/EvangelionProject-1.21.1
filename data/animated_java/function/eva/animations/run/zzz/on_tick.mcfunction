...
execute if score @s aj.run.frame matches -1 run function animated_java:eva/animations/run/zzz/function_keyframe_loop_patch
data remove storage animated_java:temp args
execute store result storage animated_java:temp args.frame int 1 run scoreboard players get @s aj.run.frame
function animated_java:eva/animations/run/zzz/apply_frame with storage animated_java:temp args
