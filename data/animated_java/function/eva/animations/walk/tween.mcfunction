...
tag @s add aj.eva.animation.walk.playing
...
execute at @s run function animated_java:eva/animations/walk/zzz/apply_frame {frame: 0}
$execute at @s run function animated_java:eva/animations/walk/zzz/apply_frame {frame: $(to_frame)}
